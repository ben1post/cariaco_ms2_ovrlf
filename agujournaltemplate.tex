...
\item A gradient forest analysis of the community data reveals that the strongest predictor of shifts within the community is the AMO index, which points to a strong impact of large scale climatic oscillations in the tropical coastal ecosystem.
\end{keypoints}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{fig/TimeSeriesOverview2.pdf}
\caption{caption}
\end{figure}

\begin{figure}
\noindent\includegraphics[width=\textwidth]{fig/AllCorrelationsPlot.pdf}
\caption{caption}
\end{figure}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{fig/GF_output_plot2.pdf}
\caption{caption}
\end{figure}
