...
% Topic Overview
Phytoplankton are microscopic algae that form the foundation of marine food webs and ecosystems. Their growth and community composition are impacted by the local physical and chemical environment, which is determined by currents and climate, for example, through processes such as wind-driven upwelling of nutrients from the deeper ocean. Time series data of phytoplankton biomass and community composition can be very helpful in untangling the link between global and local climate and its effects on the phytoplankton community.
% Paper Overview
In this study, we set out to analyze changes in the phytoplankton community between 1995 and 2017 at a time series location in a large coastal basin in Venezuela, the Cariaco Basin. Previous analysis of the data found strong shifts within the phytoplankton community that could be related to impacts of global warming. Our main question in approaching the data was whether we can confirm this shift in community composition or whether other climate processes can explain the observed patterns. 
% Findings Summary
We found that the phytoplankton community could be separated into two groups. The first group includes an early and late period (1995-2003 and 2014-2017) that was characterized by robust phytoplankton growth driven by relatively strong upwelling of nutrients. The second group is the intermediate period, where a reduction in upwelling and phytoplankton biomass was observed. Additionally, we related physical and climatic variables, such as sea surface temperature and climate indices that relate to long-term oscillations in the North Atlantic, to the changes in community composition. By allowing for a time lag, we found that the Atlantic Meridional Oscillation (AMO) index was the strongest predictor of community changes, with temperature and 
% Key Takeaways
