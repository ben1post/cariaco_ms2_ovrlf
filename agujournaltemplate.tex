...
% lowercase letter or number. Examples of good headings are:
    ...
    The impact of large-scale climatic processes on the observed shifts in the community is still unclear. The Atlantic Multidecadal Oscillation (AMO) has emerged as an important indicator of the climate system and its effects on the ecosystems of the north Atlantic \cite{nye_ecosystem_2014}. The oscillations of the AMO index are strongly correlated with temperature indices in the Caribbean region \cite{stephenson_changes_2014}.
