...
- The Cariaco basin is a system, that...
    - Discuss cell count collapse, apparent shift, but not as strong! Limitations of microscopy.
...
%need to rephrase below (from Pinckney)
During the early years of the time series (1996–2004), the Cariaco basin experienced a regular seasonal upwelling cycle driven by strong Trade Winds during winter and spring (December – April) \cite{mullerkarger_annual_2001, astor_seasonal_2003}. This upwelling period represented \qty{\sim 70}{\%} of annual depth-integrated primary production with a phytoplankton community dominated by microphytoplankton (diatoms, dinoflagellates, and coccolithophorids) \cite{pinckney_phytoplankton_2015}.
Following 2004, the physical and biogeochemical regime had changed to one with significantly reduced Trade Winds during the upwelling period, resulting in higher sea surface temperatures and less pronounced mixing of the surface and deep layers \cite{taylor_ecosystem_2012}. The microscopy cell counts indicate a collapse of large phytoplankton and diatoms in particular, which is confirmed to a lesser degree by pigment data analysis. In general, a shift in the phytoplankton community to smaller cell sizes and higher abundances of coccolithophores, cryptophytes, and other phytoflagellates, typical for stratified water columns was observed \cite{pinckney_phytoplankton_2015}.

- Now mention how the variables overlap in anomalies in Figure 2, how that can be linked to the general changes already observed by other studies.
