...
\begin{abstract}
Phytoplankton play a crucial role in Earth's biogeochemical cycles. Climate drives changes in the physical environment of phytoplankton communities, which can, in turn, affect the productivity and diversity of the entire ecosystem. Long-term time series can capture changes in climate and the ecosystem, allowing for the untangling of effects acting on a local population. 
This study aims to describe and investigate the drivers of changes observed in the phytoplankton community of the Cariaco Basin, Venezuela, between 1995 and 2017. Monthly cruises sampled microscopy cell counts and biogeochemical properties, which we extend with data from AMO and MEI v.2 climate indices, as well as the ERA5 climate model reanalysis. 
We describe and relate changes in bottom-up drivers of the upwelling system with the time series of phytoplankton biomass and diversity. Using clustering algorithms, we investigate the structure in the community time series data, revealing two clusters that describe a shift from high to low upwelling conditions in 2004, but also show a return to a community and conditions similar to those before the shift in 2014. Our results suggest that community diversity did not follow the same pattern but instead was diminished between 1998 and 2009. To quantify the effect of climate and bottom-up drivers on phytoplankton community changes, we employed a gradient forest analysis and found that a combination of in situ upwelling-related metrics (SST and nitrate concentration) and climate indices (AMO and MEI v.2) were the strongest predictors. Our study emphasizes the impact of decadal-scale climate oscillations, such as the AMO, on the phytoplankton community in a tropical coastal ecosystem through modulation of the upwelling system and highlights the resilience of ecosystems to recover from climate changes. 
...
% lowercase letter or number. Examples of good headings are:
    ...
    Long-term time series of biological observations are crucial to understanding how marine ecosystems respond to temporary shifts, cyclic processes, and long-term changes in the local physical environment and climate \cite{carstensen_need_2014, henson_observing_2016}. Unfortunately, such time series are rare, particularly in the tropics \cite{clarke_does_2017}, where community diversity is often highest \cite{brown_why_2014, righetti_global_2019} and faces greater threats of extinction compared to temperate regions \cite{finnegan_paleontological_2015}. 
    ...
    The shift in the community, due to the warming trend and the reduction in upwelling intensities, does not appear to be a permanent regime shift. Data from 2012 until the end of the CARIACO time series in 2017 indicate a return to stronger upwelling intensities and phytoplankton productivity levels similar to those of the late 1990s \cite{muller-karger_scientific_2019}.
    % What drives the changes??? Bottom-up/ Top-down ... CLIMATE
    Previous analyses of the phytoplankton community did not include time series data beyond 2011, and \citeA{taylor_ecosystem_2012} cautioned that the observed changes cannot be clearly identified as 
    "unidirectional trends driven by anthropogenic climate change or whether they simply reflect low-frequency natural cycles, such as those driving the Atlantic Multidecadal Oscillation" (AMO). 
    From this background, we aim to 1) investigate and relate changes in the depth distribution of biomass and community diversity over the entire time series, 2) check the structure and temporal changes of the phytoplankton community and 3) check whether in-situ upwelling metrics or climatic indices are better predicotrs of community change...
    % - microscopy data was not analyzed in detail, particularly towards time series of diversity.
    % Question: Does phytoplankton diversity follow the trends in biomass?
    We aim to investigate and relate changes in the depth distribution of biomass and community diversity over the entire time series.

    % What drives the changes??? Bottom-up/ Top-down ... CLIMATE
    Previous analyses of the phytoplankton community did not include time series data beyond 2011, and \citeA{taylor_ecosystem_2012} cautioned that the observed changes cannot be clearly identified as 
    "unidirectional trends driven by anthropogenic climate change or whether they simply reflect low-frequency natural cycles, such as those driving the Atlantic Multidecadal Oscillation" (AMO). 
    
    The impact of large-scale climatic processes on the observed shift in the community is still unclear. 
    %ENSO MEI v.2
    The El Niño Southern Oscillation (ENSO) has a strong teleconnection to the Caribbean Sea, as during ENSO (indicated by a positive MEI v.2 index) sea surface temperatures rise and trade winds blow more to the north-northwest \cite{enfield_tropical_1997}.
    
    \citeA{taylor_ecosystem_2012} found no strong correlation between the MEI v.2 and measurements in the Cariaco basin, despite strong teleconnection effects in the tropical Atlantic \cite{enfield_tropical_1997}.
...
%% Gaps that We Adresse:
    ...
    Factors act at different scales \cite{wolkovich_temporal_2014}
    We aim to examine correlations and structures in time series data at monthly and annual time scales.
...
\toprule
Variable Name & Units & Mean & Range & Std. Dev. & Data source \\
\midrule
...
% Figure 4
Taking the microscopy community data, interpolated within the top 100 meters, we wanted to find if there was an apparent structure within the time series that could be related to the physical environment. To achieve this, we employed clustering analysis, both on the annual aggregate of cell counts from microscopy and on the individual monthly measurements. Figure \ref{fig:clustering} $a$ shows the results of clustering the annual aggregate communities with a linear complete linkage algorithm based on the binary Jaccard matrix. The community is divided into two groups, with the first cluster including the years 1996-2004 and 2014-2016 and the second cluster of the intermediate years from 2004-2013. 
...
This study demonstrates the highly dynamic nature of a tropical coastal marine ecosystem driven by local environmental variability, which, in turn, is affected by large-scale climatic changes. In the Cariaco Basin, decadal-scale climate oscillations have influenced the wind-driven upwelling regime, resulting in confounding effects on the composition and biodiversity of the phytoplankton community.
% - a few sentences on basic seasonal dynamics removed here
These changes are well reflected in the yearly mean anomalies (see Figure \ref{fig:zscore}) and the density distribution of monthly measurements (see Figure \ref{fig:clustering}). After 2004, we observe higher sea surface temperatures (SST), lower wind speeds, reduced fluorometric chlorophyll \textit{a}, and a collapse in functional group cell counts, all corresponding with a shift in the the Atlantic Multidecadal Oscillation (AMO) toward positive mean anomalies until 2014. 
...
The period between 2001 and 2006 lacks coverage in HPLC data, necessitating reliance on microscopy counts to deduce changes in the phytoplankton community. This limitation restricts the observable phytoplankton size range and the measurable diversity through the sampling methodology \cite{cermeno_sampling_2014}. We can see a marked reduction in the genus richness of microphytoplankton ahead of the collapse in abundance, and similarly an increase a few years ahead of the return in abundance to previous levels. 
