...
This study aims to describe and investigate the changes in phytoplankton community in the Cariaco Basin, Venezuela, between 1995 and 2017. Water samples were taken during monthly cruises to determine microscopy cell counts and biogeochemical properties, which we integrated with data from the AMO and MEI v.2 climate indices and ERA5 climate model reanalysis data. 
