...
% lowercase letter or number. Examples of good headings are:
    ...
    One such project is the CARIACO time series, which has seen consistent sampling of hydrographic and biogeochemical parameters in the Cariaco basin off the coast of Venezuela between 1995 and 2017 \cite{muller-karger_scientific_2019}. The Cariaco basin is one of the most productive ecosystems in the Caribbean Sea \cite{bringue_physico-chemical_2018}, with seasonal upwelling driven by trade winds during December through May and a secondary upwelling observed in July and August \cite{mullerkarger_annual_2001, astor_seasonal_2003}. The basin is anoxic at depths below \qty{\sim 275}{m}, due to microbial respiration of sinking organic matter and restricted bottom water circulation, leaving a rich sedimentary record for the study of past climate \cite{hughen1996nature}.
    ...
    "The Cariaco Basin, located ...." - general hydrography/depth, etc.
...
% Pinckney et al. 2015:
- major thing is that previous paper only looked at microscopy to 55m (Mutshinda and Pinckney), but now we look at full 100 m!
